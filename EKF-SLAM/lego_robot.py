#contains all plotting functionalities for Uni Hannover SLAM LiDAR data
from math import sin, cos, pi

#converted from py2 to py3, compatible with numpy version too...
    ...
    def read(self, filename):
        ...
        with open(filename) as f:
            for l in f:
                ...
                # PA is particles---for particle filters only
                elif sp[0] == 'PA':
                    if first_particles:
                        self.particles = []
                        first_particles = False
                    vals = list(map(float, sp[1:]))
